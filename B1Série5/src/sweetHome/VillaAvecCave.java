...
public class VillaAvecCave extends Villa{
    ...
    public VillaAvecCave(String adresse, int nbChambres, int nbEtages, double surfacecRezChaussee, double surfaceHabitableEtages, double superficieTerrain, Proprietaire proprietaire, double surfaceCave, boolean aGarageEnSousSol) {
        super(adresse, nbChambres, nbEtages, surfacecRezChaussee, surfaceHabitableEtages, superficieTerrain, proprietaire);
    ...
    public VillaAvecCave(String adresse, int nbChambres, int nbEtages, double surfacecRezChaussee, double surfaceHabitableEtages, double superficieTerrain, double surfaceCave, boolean aGarageEnSousSol) {
        super(adresse, nbChambres, nbEtages, surfacecRezChaussee, surfaceHabitableEtages, superficieTerrain, null);
